...
fun main() {
    ...
    if (!checkLength(userLogin) || !checkLength(userPassword)) println("Логин или пароль недостаточно длинные")
    else println("Всё верно!")

}

fun checkLength(userString: String): Boolean {
